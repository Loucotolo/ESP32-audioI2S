...
extern __attribute__((weak)) void audio_fail_stream(const char*); //
extern __attribute__((weak)) void audio_start_stream(const char*); //
//----------------------------------------------------------------------------------------------------------------------
...
protected:
    size_t   m_buffSizePSRAM    = 600000;   // most webstreams limit the advance to 100...300Kbytes
...
public:
    ...
    bool connecttohost(const char* host, bool mp3local = false , const char* user = "", const char* pwd = "");
